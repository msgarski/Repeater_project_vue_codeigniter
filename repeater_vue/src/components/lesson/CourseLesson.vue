  ...
  <li>
    <router-link :to="'/innerlesson/' + lessonId">
      <div>
        ...
        <div v-if="lessonInfo">
          ...
          <div class="learning">
            ...
            <div v-show="lessonInfo.for_learning >= 10" id="btn">
              <button @click="getBatchLearningOfCourse" class="button">
                Ucz się
              </button>
            </div>
          </div>
        ...
        <div class="btn-edit">
          <router-link :to="'/editlesson/' + lessonId"
            ><button class="button">Edytuj</button></router-link
          >
        </div>
        ...
        <div class="button-tab">
          <div class="btn">
            <router-link :to="'/massimport/' + lessonId"
              ><button class="button-2">Dodaj wiele kart</button></router-link
            >
          </div>
          <div class="btn">
            <router-link :to="'/singleimport/' + lessonId"
              ><button class="button-2">
                Dodaj karty pojedynczo
              </button></router-link
            >
          </div>
        </div>
...
export default {
  name: "course-lesson",
  props: ["lessonId", "name", "description"],
  data() {
    return {
      lessonInfo: null,
    };
