<template>
    ...
    <div class="button-tab">
      <div class="btn">
        <router-link :to="'/massimport/' + lessonId"
          ><button class="button-1">Dodaj wiele kart</button></router-link
        >
      </div>
      <div class="btn">
        <router-link :to="'/singleimport/' + lessonId"
          ><button class="button">Dodaj karty pojedynczo</button></router-link
        >
      </div>
    </div>
  </div>
  ...
  <div class="table-container">
    ...
    <div class="btn-1">
      <button @click="backToPrevious" class="button">
        Powrót do widoku kursu
      </button>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getCardsForLesson() {
      http
        .get("cards/fillLessonTable/" + this.lessonId)
        .then((result) => {
