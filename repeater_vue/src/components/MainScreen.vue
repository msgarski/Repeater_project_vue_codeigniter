  ...
  <div class="container">
    ...
    <div class="btn">
      <router-link to="/newcourse"
        ><button class="button-1">Dodaj kurs</button></router-link
      >
    </div>
    <div class="btn">
      <router-link to="/settings"
        ><button class="button">Opcje główne</button></router-link
      >
    </div>
  </div>
  <div>
  ...
  <div class="list-container">
    <div v-if="coursesAreLoaded">
      ...
      <div v-else-if="courses.length == 0">
        Nie masz żadnych kursów,
        <router-link to="/newcourse">Dodaj jakiś kurs</router-link>
      </div>
    </div>
